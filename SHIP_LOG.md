...
*Nothing staged yet. v1.7.3 shipped.*
...
| Version | Title | Date |
|---------|-------|------|
| [v1.7.3](devnotes/releases/v1.7.3.md) | Performance Tune-Up: Sentry Sampling, ISR & Query Dedup ⚡📉 | Jun 11, 2026 |
| [v1.7.2](devnotes/releases/v1.7.2.md) | Sentry Observability Wiring 🔭 | Apr 13, 2026 |
| [v1.7.1](devnotes/releases/v1.7.1.md) | ISR Cache Invalidation Fix 🐛🔄 | Mar 11, 2026 |
...
| [v1.3.8](devnotes/releases/v1.3.8.md) | Smart Bluesky Post URL Handling 🦋 | Jan 31, 2026 |
