...
Use this strategy whenever you feel you are missing information or making assumptions mid-generation and cannot stop to verify. This includes if you find yourself wishing you had committed to a different implementation partway through.
...
## Command Execution
When you use `/completion-drive [task]`, the agent will:
...
At the end of each session, provide a comprehensive report:
...
## Key Files
- `docs/completion_drive_plans/` - Planning phase output directory
...
- Clean up ALL tags before considering the task complete
